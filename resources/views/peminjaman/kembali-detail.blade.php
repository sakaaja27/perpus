...
<div class="row">
	    <div class="col-md-12">
	        <div class="box box-primary">
				...
				<a href="/kembali-cetak-detail/{{$log->id}}"  class="btn btn-info btn-sm mb-2"><i class="bi bi-printer"></i> PDF</a>
			</div>
			    <!-- /.box-header -->
			    <div class="box-body">
						<div class="row">
                        ...
                        <div class="pull-right">
							<a href="/daftarkembali" class="btn btn-danger btn-md">Kembali</a>
						</div>
		        </div>
	        </div>
	    </div>
