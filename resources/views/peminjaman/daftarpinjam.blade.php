...
<div class="col-md-12 mx-auto" >
	...
	<div class="card">
		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4 mx-auto">
			<h1 class="h3 mb-0 text-gray-800 mt-1">List Daftar Pinjam</h1>
		</div>
		<div class="card-body ">
			<div class="d-flex justify-content-end">
				
				<a href="pinjambuku"  class="btn btn-info btn-sm mb-2"><i class="fa fa-plus"></i>Book Rent</a>
			</div>
			<table id="table-data" class="table table-striped table-hover table-akuhh">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<button class="btn btn-info btn-sm" > <a href="pinjam-detail/{{$a->id}}"> <i class="fa fa-eye text-white"></i></a></button>
							<a href="pinjam-delete/{{$a->id}}" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus ?');"> <i class="fa fa-trash text-white"></i></a>
